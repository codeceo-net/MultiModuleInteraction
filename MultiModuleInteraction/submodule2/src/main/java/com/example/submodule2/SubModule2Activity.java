...
public class SubModule2Activity extends Activity {
    ...
    public void getDataFromOtherModule(View view) {
        ...
        try {
           ...
           Bundle bundle1= CleanDelegate.getInstance().getData(Submodule2DelegateConsts.FACTORY, Submodule2DelegateConsts.DataCode.getTotalMemoryByte,bundle,SubModule2Activity.this);
